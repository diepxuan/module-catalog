...
namespace Diepxuan\Catalog\Controller\Adminhtml\Category;
 ...
 * Class Edit
 */
class Edit extends \Diepxuan\Catalog\Controller\Adminhtml\Category implements HttpGetActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Diepxuan_Catalog::catalog_categories');
